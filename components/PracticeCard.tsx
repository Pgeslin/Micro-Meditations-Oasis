...
export const PracticeCard: React.FC<PracticeCardProps> = ({ practice, onSelect }) => {
  return (
    <div
      className="bg-white p-6 rounded-xl shadow-md border border-slate-200 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col items-start h-full cursor-pointer"
